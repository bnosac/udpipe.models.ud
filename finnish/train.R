...
settings$treebank <- "fi"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Finnish")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.fi.vec"
...
m <- udpipe_train(file = settings$modeloutput, 
                  ...
                  annotation_tokenizer = list(dimension = 64, epochs = 100, initialization_range = 0.1, 
                                              batch_size = 100, learning_rate = 0.005, dropout = 0.3, early_stopping = 1),
                  annotation_tagger = list(models = 2, templates_1 = "tagger", guesser_suffix_rules_1 = 10, 
                                           ...
                                           templates_2 = "lemmatizer", guesser_suffix_rules_2 = 8, guesser_enrich_dictionary_2 = 5, 
