...
settings$language <- "norwegian-bokmaal"
settings$treebank <- "no_bokmaal"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Norwegian-Bokmaal")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.no.vec"
