...
settings$treebank <- "nl"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Dutch")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.nl.vec"
...
m <- udpipe_train(file = settings$modeloutput, 
                  ...
                  annotation_tagger = list(models = 2, templates_1 = "tagger", guesser_suffix_rules_1 = 8, 
                                           ...
                                           templates_2 = "lemmatizer", guesser_suffix_rules_2 = 6, guesser_enrich_dictionary_2 = 4, 
