...
settings$language <- "czech-cac"
settings$treebank <- "cs_cac"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Czech-CAC")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.cs.vec"
...
m <- udpipe_train(file = settings$modeloutput, 
                  ...
                  annotation_tokenizer = list(dimension = 24, epochs = 100, initialization_range = 0.1, 
                                              batch_size = 50, learning_rate = 0.005, dropout = 0.1, early_stopping = 1),
                  annotation_tagger = list(models = 2, templates_1 = "tagger", guesser_suffix_rules_1 = 8, 
                                           ...
                                           provide_xpostag_1 = 1, provide_feats_1 = 1, prune_features_1 = 1, 
                                           templates_2 = "lemmatizer", guesser_suffix_rules_2 = 6, guesser_enrich_dictionary_2 = 5, 
