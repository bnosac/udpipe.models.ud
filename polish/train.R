...
settings$treebank <- "pl"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Polish")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.pl.vec"
