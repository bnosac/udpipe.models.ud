...
settings$language <- "japanese-ktc"
settings$treebank <- "ja_ktc"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Japanese-KTC")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.ja.vec"
...
m <- udpipe_train(file = settings$modeloutput, 
                  ...
                  annotation_tokenizer = list(dimension = 64, epochs = 100, initialization_range = 0.1, 
                                              batch_size = 50, learning_rate = 0.005, dropout = 0.3, early_stopping = 1),
                  annotation_tagger = list(models = 2, templates_1 = "tagger", guesser_suffix_rules_1 = 12, 
                                           guesser_enrich_dictionary_1 = 4, guesser_prefixes_max_1 = 0, 
                                           use_lemma_1 = 0, use_xpostag_1 = 1, use_feats_1 = 1, provide_lemma_1 = 0, 
                                           provide_xpostag_1 = 1, provide_feats_1 = 1, prune_features_1 = 0, 
                                           templates_2 = "lemmatizer", guesser_suffix_rules_2 = 6, guesser_enrich_dictionary_2 = 6, 
                                           guesser_prefixes_max_2 = 4, use_lemma_2 = 1, use_xpostag_2 = 1, 
                                           use_feats_2 = 1, provide_lemma_2 = 1, provide_xpostag_2 = 0, 
                  ...
                  annotation_parser = list(iterations = 30, embedding_upostag = 20, embedding_feats = 20, 
                                           ...
                                           learning_rate_final = 0.001, l2 = 0.3, hidden_layer = 200, 
                                           batch_size = 10, transition_system = "projective", transition_oracle = "static", 
