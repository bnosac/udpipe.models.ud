...
settings$treebank <- "pt"
settings$ud <- sprintf("https://raw.githubusercontent.com/UniversalDependencies/%s/master", "UD_Portuguese")
...
settings$wordvectors <- "https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.pt.vec"
settings$modelname <- sprintf("%s-ud-2.1-%s.udpipe", settings$treebank, format(settings$date, "%Y%m%d"))
...
m <- udpipe_train(file = settings$modeloutput, 
                  ...
                  annotation_tokenizer = list(dimension = 24, epochs = 100, initialization_range = 0.1, 
                                              batch_size = 100, learning_rate = 0.01, dropout = 0.1, early_stopping = 1),
                  annotation_tagger = list(models = 2, templates_1 = "lemmatizer", guesser_suffix_rules_1 = 6, 
                                           guesser_enrich_dictionary_1 = 6, guesser_prefixes_max_1 = 4, 
                                           use_lemma_1 = 1, use_xpostag_1 = 0, use_feats_1 = 0, provide_lemma_1 = 1, 
                                           provide_xpostag_1 = 0, provide_feats_1 = 0, prune_features_1 = 0, 
                                           templates_2 = "tagger", guesser_suffix_rules_2 = 12, guesser_enrich_dictionary_2 = 5, 
                                           guesser_prefixes_max_2 = 0, use_lemma_2 = 1, use_xpostag_2 = 1, 
                                           use_feats_2 = 1, provide_lemma_2 = 0, provide_xpostag_2 = 1, 
                                           provide_feats_2 = 1, prune_features_2 = 1, dictionary_max_form_analyses_2 = 10),
                  annotation_parser = list(iterations = 30, embedding_upostag = 20, embedding_feats = 20, 
                                           ...
                                           batch_size = 10, transition_system = "link2", transition_oracle = "static", 
